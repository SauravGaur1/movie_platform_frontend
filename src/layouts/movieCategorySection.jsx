...
function MovieCategorySection({category}) {
    const movieCardModel = new MovieCardModel({
        imageSrc:
            "https://static1.moviewebimages.com/wordpress/wp-content/uploads/movie/DAK6opQdLLTti1I0Cs2CWTZK0AoqdW.jpg?q=50&fit=crop&w=320&dpr=1.5",
    ...
    return (
        <div>
            ...
            <HorizonalScrollView>
                <CardWrapper>
                    <MovieCard movieCardModel={movieCardModel} />
                </CardWrapper>
                <CardWrapper>
                    <MovieCard movieCardModel={movieCardModel} />
                </CardWrapper>
